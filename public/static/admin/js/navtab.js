...
layui.define(['element'], function(exports){
   var  element = layui.element(),
         ...
         * [参数设置 options]
         */
        A7LAYATab.prototype.set = function(options){
              var _this = this;
         ...
         */
        A7LAYATab.prototype.init  = function(){
             var _this = this;
         ...
         */
        A7LAYATab.prototype.exists = function(title){
         ...
         * @return {[type]}      [description]
         */
        A7LAYATab.prototype.tabAdd = function(data){
            var _this = this;
