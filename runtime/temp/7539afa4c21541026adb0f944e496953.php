<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"C:\Users\Administrator\Desktop\amazon_web\public/../application/index\view\index\sign_up.html";i:1554956000;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="panel panel-sign">
                <form action="signUpRes">
                    <div class="form-group">
                        ...
                        <input name="username" type="text" class="form-control" placeholder="Input your username" id="username">
